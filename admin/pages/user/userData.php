...
<div class="card">
    ...
    <div class="card-body overflow-auto">
        <button type="button" class="btn btn-primary  float-right my-2"><a href="userAdd.php" class="text-decoration-none text-white">Add Record</a></button>
                ...
                while ($row = $data->getPackage->fetch()) { ?>
                    ...
                    <tr class='updataForm d-none'>
                        <form action="../../back/systemController.php" method="POST">
                            ...
                            <td><input required type="email" name="email" class='form-control' value="<?php echo $row['email'] ?>"> </td>
                            <td><input required type="password" name="password" class='form-control' value="<?php echo $row['password'] ?>"> </td>
                            <td>
                                <input type="hidden" name="id" value="<?php echo $row['id'] ?>">
