...
<div class="card">
    ...
    <div class="card-body overflow-auto">
        <button type="button" class="btn btn-primary  float-right my-2"><a href="serviceAdd.php" class="text-decoration-none text-white">Add Record</a></button>
